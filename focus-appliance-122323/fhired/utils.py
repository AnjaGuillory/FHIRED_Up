...
#
#         risk_value = 0
#         for hcc_by_time in self.get_hccs(patient_id, current_year)[0]:
#             risk_value += look_up.hcc_to_risk_score_value(hcc_by_time)
#
#         if include_selected:
#             # add on the value for the "missing" HCCs
#             missing_diag = self.find_missing_diagnoses(self.get_hccs(patient_id, current_year)[0],
#                                                        self.get_hccs(patient_id, current_year)[1])
#
